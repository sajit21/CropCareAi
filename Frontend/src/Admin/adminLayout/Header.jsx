    ...
    <header className="sticky top-0 flex w-full bg-white border-gray-200 z-99999 dark:border-gray-800 dark:bg-gray-900 lg:border-b">
      <div className="flex flex-col items-center justify-between grow lg:flex-row lg:px-6">
        <div className="flex items-center justify-between w-full gap-2 px-3 py-3 border-b border-gray-200 dark:border-gray-800 sm:gap-4 lg:justify-normal lg:border-b-0 lg:px-0 lg:py-4">
          ...
          <Link to="/" className="lg:hidden flex items-baseline gap-2 justify-center">
            <img className="dark:hidden h-5 w-auto" src="/plant.png" alt="Logo" />
             <h1 className="text-xl font-bold ">Fix Plant</h1>
          </Link>
          ...
          <div className="relative">
                    ...
                    {user && ( <div  ref={userProfileMenuRef} className=" relative  h-7 w-7 rounded-full  cursor-pointer">
                     ...
                     <div className="w-full h-full overflow-hidden rounded-full">
                       <img onClick={toggleProfileMenu}   src={user.Photo} alt="user profile" className="w-full h-full object-cover " />
                     </div>
